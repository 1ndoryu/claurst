...
impl App {
    ...
    pub fn handle_key_event(&mut self, key: KeyEvent) -> bool {
        ...
        match key.code {
            ...
            // ---- Smooth scroll with Ctrl+Up / Ctrl+Down (3 lines) ------
            // También Ctrl+Shift+Up/Down como alternativa para VS Code
            // terminal, que intercepta Ctrl+Up/Down para su propio scroll.
            KeyCode::Up
                if key.modifiers.contains(KeyModifiers::CONTROL)
                    && !key.modifiers.contains(KeyModifiers::SHIFT) =>
            {
            ...
            // Ctrl+Shift+Up/Down: pasa a través de VS Code terminal
            // (no lo intercepta) y funciona igual que Ctrl+Up/Down.
            KeyCode::Up
                if key.modifiers.contains(KeyModifiers::CONTROL)
                    && key.modifiers.contains(KeyModifiers::SHIFT) =>
            {
